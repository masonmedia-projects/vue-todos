<template>
    <div class="p-2 bg-dark-grape position-fixed" 
    style="right: 0; z-index: 1000; cursor: pointer; border-radius: 0 0 0 50%;">
        <b-icon icon="filter-right" variant="light" class="m-2" style="outline: 0;"
